...
async function iniciarCreacionGmail() {
  console.log("🤖 [BOT-GMAIL] Iniciando flujo de registro automatizado...");
  ...
  try {
    ...
    const urlRegistro = "https://accounts.google.com/signup";
    console.log("🌐 [BOT-GMAIL] Navegando al registro de Google...");
    ...
    const campoNombre = page.locator("input[name='firstName']");
    ...
    const campoApellido = page.locator("input[name='lastName']");
    ...
    // ─── PASO 3: SELECCIÓN / CREACIÓN DEL NOMBRE DE USUARIO ───
    ...
    // ─── PASO 4: PANTALLA DE CONTRASEÑA (CORREGIDO) ───
    console.log("⏳ [BOT-GMAIL] Esperando pantalla de creación de contraseña...");
    
    // Seleccionamos de forma explícita el primer input de contraseña de la pantalla
    ...
    // CORRECCIÓN CLAVE: Seleccionamos el segundo input de contraseña (.nth(1)) de manera infalible
    ...
    console.log("🚀 [BOT-GMAIL] Módulo de contraseña superado con éxito. Verifique el estado actual de la ventana.");
